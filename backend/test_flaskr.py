...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}:{}@{}/{}".format(
            'johnlockwood', 'jal109', 'localhost:5432', self.database_name)
    ...
    def test_delete_question_by_id(self):
        ...
        query = Question.query.filter(
            Question.question == self.question_data['question']).first()
    ...
    def test_list_questions_in_category(self):
        ...
        self.assertEqual(res.status_code, 200)
        # #don't test for questions because there might
        # #not be any questions in that list yet
        # self.assertTrue(data['question'])
